...
import { useAutoSummarizeDocument } from '@/hooks/use-auto-summarize-document';
...
const DocumentEditor: React.FC<DocumentEditorProps> = ({
  ...
  const autoSummarizeDocument = useAutoSummarizeDocument({
    documentId: currentDocumentId,
    projectId: document?.project_id ?? currentProjectId,
